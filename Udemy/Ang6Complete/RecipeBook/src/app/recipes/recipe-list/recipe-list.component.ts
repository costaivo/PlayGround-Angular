...
export class RecipeListComponent implements OnInit {
  ...
  recipes: Recipe[] = [
    new Recipe('Mackerel Fish Fry', 'Mackerel Fish Fry With Goan Recheado Masala', 'http://67.205.180.25/wp-content/uploads/2016/07/mackerel-fish-fry-with-goan-recheado-masala.1024x1024.png'),
